...
import Signup from '../styling/signup'
...
export const styles = theme => {
  return ({
    ...
    paper: {
      ...
      alignItems: 'row',
      padding: `${theme.spacing.unit * 0}px ${theme.spacing.unit * 3}px ${theme.spacing.unit * 3}px`,
    },
    avatar: {
        ...
        <Paper >
          <form onSubmit={this.handleSubmit}>
            ...
            <div hidden={this.props.formType === 'Register' ? null : "hidden"}>
              <label> Your Name <br />
                <input type="text" onChange={this.update('first_name')} value={this.state.username} />
              </label>
            </div>
            <input
